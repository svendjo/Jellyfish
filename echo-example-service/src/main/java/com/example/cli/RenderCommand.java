...
import com.example.EchoExampleServiceConfiguration;
...
public class RenderCommand extends ConfiguredCommand<EchoExampleServiceConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<EchoExampleServiceConfiguration> bootstrap,
                       Namespace namespace,
                       EchoExampleServiceConfiguration configuration) throws Exception {

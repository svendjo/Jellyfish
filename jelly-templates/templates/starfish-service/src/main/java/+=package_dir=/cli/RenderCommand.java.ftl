...
import ${package}.${ServiceName}Configuration;
...
public class RenderCommand extends ConfiguredCommand<${ServiceName}Configuration> {
    ...
    @Override
    protected void run(Bootstrap<${ServiceName}Configuration> bootstrap,
                       Namespace namespace,
                       ${ServiceName}Configuration configuration) throws Exception {

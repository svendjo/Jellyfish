...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <build>
    ...
    <plugins>
      ...
      <plugin>
        <!-- Copy the api.yaml file to the build output directory -->
        <groupId>org.apache.maven.plugins</groupId>
        ...
        <executions>
          <execution>
            ...
            <configuration>
              ...
              <configOptions>
                <sourceFolder>src/main/java</sourceFolder> <!-- doesn't seem all that optional - factories won't be found -->
              </configOptions>
            </configuration>
          </execution>
        </executions>
      ...
      <plugin>
        ...
        <executions>
          ...
          <!-- Copies environment config resources from environment-config to target/environment-config -->
          <execution>
